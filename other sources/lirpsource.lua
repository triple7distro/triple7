...
r0_0("Brzzz_HOOK 1/5", "Main Script Is Loading...", 5)
local r1_0 = {
  a = "$512@",
  b = "*8#74",
  c = "#9$63",
  ...
  if loadstring == print then
    ...
    elseif r29_0[r30_0(r16_0)] then
      ...
      if Blr then
        ...
        if not _G.Injected then
          ...
          r0_0("Brzzz_HOOK Loader", "You Executed The Script Twice Stopping Execution.", 5)
          return 
        end
        ...
        if not r33_0 or not r32_0 then
          r0_0("Brzzz_HOOK | Project Delta", "Error: 402", 5)
          _G.Injected = false
        ...
        if not r25_0 or not r24_0 or not r26_0 or not r27_0 then
          r0_0("Brzzz_HOOK (A)", "Something Didnt Load Corectly - Rejoin And Try Again", 15)
          _G.Injected = false
          _G.InjectedGui = false
          return 
        end
        ...
        function r38_0(r0_1)
          ...
          r14_0 = true
          r22_0("[Script] Brzzz_HOOK hasn't got key but key got changed to: `" .. r0_1 .. "`", true)
          Save("92, 33, 33, 33, 23", "InfYield")
          Save("92, 33, 33, 33, 23", "InfYield")
          setclipboard(" ")
          while true do
        ...
        if not (function()
          ...
          if not r39_0 then
            ...
            r0_0("Brzzz_HOOK 2/5", "Loading Functions", 2.5)
            ...
            task.spawn(function()
              -- line: [0, 0] id: 56
              r0_0("Brzzz_HOOK 3/5", "Creating UI", 2.5)
              ...
              if not r39_0.Lobby then
                local r44_56 = r42_56.element("Button", "Only Available In Lobby!", false, function(r0_217)
                  -- line: [0, 0] id: 217
                  r0_0("Brzzz_HOOK", "This helps you find servers easier")
                end)
              end
	...
	r39_0.AnimDown = r0_300.Toggle
    	...
    	r39_0.FlipMode = r0_301.Toggle
        	...
        	disableFlipMode()
              ...
              local r143_56 = r26_56.element("Button", "Amogus", false, function(r0_134)
                ...
                if r39_0.UPAngleChanger then
                  r0_0("Brzzz_HOOK", "Amogus doesn\'t work while you have Yaw Changer enabled.", 1.5)
                  return 
                end
              ...
              task.spawn(function()
                ...
                r2_84 = r2_84(r3_84, "Join random server", false, function(r0_100)
                  ...
                  if r2_100 then
                    ...
                    r0_0("Brzzz_HOOK | Servers", "No server has been found to be suitable with your current requirements.", 2.5)
                  end
                end)
                r3_84 = r43_56
                r3_84 = r3_84.element
              ...
              local r191_56 = r21_56.element("Button", "Save Config", false, function(r0_110)
                ...
                r0_0("Brzzz_HOOK | Configs", "Config Named: " .. r189_56 .. " Was Saved", 5)
              end)
              local r192_56 = r21_56.element("Button", "Load Config", false, function(r0_240)
                -- line: [0, 0] id: 240
                Save(r189_56, "AutoLoadConfig")
                r1_56.load_cfg(r189_56)
                r0_0("Brzzz_HOOK | Configs", "Config Named: " .. r189_56 .. " Was Loaded", 5)
              end)
              local r193_56 = Load("Text", "AutoLoadConfig")
              if r193_56 then
                r1_56.load_cfg(r193_56)
                r0_0("Brzzz_HOOK | Configs", "Config Named: " .. r193_56 .. " Was Loaded", 5)
              end
              r0_0("Brzzz_HOOK 3.5/4", "Finished Creating UI", 2.5)
            end)
            r0_0("Brzzz_HOOK 4/5", "Almost Done...", 2.5)
            local r90_0 = {}
            ...
            function r122_0()
              ...
              if false then --not r11_0:FindFirstChild(r37_0) then
                ...
                if r119_0 then
                  if r118_0 then
                    if not r118_0:FindFirstChild("Title") or r118_0.Title.Text ~= "Brzzz_HOOK | Project Delta | 2025/11/12 | discord.gg/8RrWuEabnc" then
                      r14_0 = true
            ...
            getgenv().Key = nil
            r0_0("Brzzz_HOOK 5/5", "Cheat Has Been Loaded Succesfuly.", 2.5)
		...
		local animDownEndConnection = r6_0.InputEnded:Connect(function(input)
		  ...
		  r0_0("Brzzz_HOOK", "Have a good time!", 5)